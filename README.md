[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=eso-status_api&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=eso-status_api)
